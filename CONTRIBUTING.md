...
- Provide the exact version of @vuestorefront/nopcommerce.
...
> @vuestorefront/nopcommerce pull requests
...
To keep the code base of @vuestorefront/nopcommerce neat and tidy the following rules apply to every change
...
To make your life easier @vuestorefront/nopcommerce is commitizen-friendly and provides the npm run-script `commit`.
